...
const TelephoneContent = () => {
    ...
    return <CardContentWrapper>
        ...
        <Stack direction="row" alignItems="center" spacing={2} sx={{mb: 3}}>
            ...
            <Stack spacing={0}>
                <Typography variant="subtitle1" align="left" lineHeight="100%" letterSpacing="0.02em" fontWeight={400}>Регистрируясь,
                    вы соглашаетесь</Typography>
                <Link href="src/components/card/content/TelephoneContent#" variant="subtitle1" align="left" lineHeight="100%" letterSpacing="0.02em"
                      sx={{":hover": {cursor: "pointer"}}} color="inherit">с правилами использования приложения</Link>
            </Stack>
        </Stack>
    </CardContentWrapper>;
}

export default memo(TelephoneContent);
